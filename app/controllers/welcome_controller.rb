class WelcomeController < ApplicationController
  def test
  	...
  	@weather_hash = {}
  	@weather_hash["location"] = response['location']['city']
	  @weather_hash["temp_f"] = response['current_observation']['temp_f']
	  @weather_hash["temp_c"] = response['current_observation']['temp_c']
	  @weather_hash["weather_icon"] = response['current_observation']['icon_url']
	  @weather_hash["weather_words"] = response['current_observation']['weather'] 
	  @weather_hash["forecast_link"] = response['current_observation']['forecast_url']
	  @weather_hash["real_feel"] = response['current_observation']['feelslike_f']
  end
